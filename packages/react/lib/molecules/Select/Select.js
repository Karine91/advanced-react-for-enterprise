...
const Select = ({ options = [], label = "Please select an option ...", onOptionSelected: handler, renderOption, }) => {
    ...
    return (React$1.createElement("div", { className: "dse-select" },
        React$1.createElement("button", { "data-testid": "DseSelectButton", onKeyDown: onButtonKeyDown, "aria-controls": "dse-select-list", "aria-haspopup": true, "aria-expanded": isOpen ? true : undefined, ref: labelRef, className: "dse-select__label", onClick: () => onLabelClick() },
        ...
        React$1.createElement("ul", { role: "menu", "aria-hidden": isOpen ? undefined : false, id: "dse-select-list", style: { top: overlayTop }, className: `dse-select__overlay ${isOpen ? "dse-select__overlay--open" : ""}` }, options.map((option, optionIndex) => {
            ...
            return (React$1.createElement("li", { ...renderOptionProps.getOptionRecommendedProps() },
